          ...
          <div className="flex items-center justify-between h-16">
            ...
            >
              ...
              <div>
                <div className="flex items-center gap-2">
                  <span className="font-display font-extrabold text-xl tracking-tight text-gov-navy">
            ...
            <div className="hidden sm:flex items-center gap-2">
              <button
                ...
                className="px-3 py-2 rounded-lg text-xs font-semibold text-slate-700 bg-slate-100 hover:bg-slate-200 border border-slate-200 transition-all flex items-center gap-1.5 shadow-sm active:scale-95"
                title="Scan QR code to open on phone"
              >
                <Smartphone className="w-3.5 h-3.5 text-gov-blue" />
              ...
              <button
                id="nav-quick-demo"
                onClick={onQuickDemo}
                className="px-3.5 py-2 rounded-lg text-xs font-semibold text-amber-900 bg-amber-50 hover:bg-amber-100 border border-amber-200 transition-all flex items-center gap-1.5 shadow-sm active:scale-95"
              ...
              <button
                onClick={() => handleNav('scanner')}
                className="px-4 py-2 rounded-lg text-xs font-bold text-white bg-gov-blue hover:bg-blue-700 transition-all flex items-center gap-1.5 shadow-sm shadow-blue-500/20 active:scale-95"
              >
            ...
            <div className="flex md:hidden items-center gap-2">
              <button
                onClick={onQuickDemo}
                className="px-2.5 py-1.5 rounded-md text-xs font-bold text-amber-900 bg-amber-100 border border-amber-300 flex items-center gap-1"
              >
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-slate-200 px-3 py-2 flex items-center justify-around shadow-lg">
        <button
          ...
          className={`flex flex-col items-center gap-0.5 py-1 px-2 rounded-lg transition-colors ${
            activePage === 'home' ? 'text-gov-blue font-bold' : 'text-slate-500'
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 py-1 px-3 rounded-lg transition-colors ${
            activePage === 'scanner' ? 'text-gov-blue font-bold' : 'text-slate-500'
          }`}
        >
        ...
        <button
          onClick={() => handleNav('result')}
          className={`flex flex-col items-center gap-0.5 py-1 px-2 rounded-lg transition-colors ${
            activePage === 'result' ? 'text-gov-blue font-bold' : 'text-slate-500'
          }`}
        >
        ...
        <button
          onClick={() => handleNav('history')}
          className={`flex flex-col items-center gap-0.5 py-1 px-2 rounded-lg transition-colors ${
            activePage === 'history' ? 'text-gov-blue font-bold' : 'text-slate-500'
          }`}
        >
