      ...
      <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] flex flex-col shadow-2xl border border-slate-200 overflow-hidden animate-fadeIn my-auto">
        ...
        <div className="p-5 sm:p-8 overflow-y-auto text-slate-800 space-y-6 text-xs sm:text-sm print:p-0">
          ...
          <div className="border-b-2 border-slate-900 pb-5 text-center">
            ...
            <div className="text-xs text-slate-600 mt-1 flex flex-wrap items-center justify-between gap-2">
              <span>Under Section 18 of The Legal Metrology Act, 2009 & Packaged Commodities Rules, 2011</span>
              <span className="font-semibold text-slate-500">Inspection Date: {currentDate}</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-6 gap-3 bg-slate-50 p-4 rounded-xl border border-slate-200 text-xs">
            ...
            <div>
              <span className="text-slate-400 block font-medium">Extraction Conf.</span>
              <strong className="text-slate-800">{Math.round((product.overallExtractionConfidence || 0.85) * 100)}%</strong>
            </div>
            <div>
